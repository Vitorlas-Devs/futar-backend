...
export default class App {
    ...
    private initializeMiddlewares() {
        ...
        this.app.use(
            cors({
                origin: ["https://lyedlikfutar.netlify.app", "https://minimal-dialogs.netlify.app", "https://jedlik-vite-quasar-template.netlify.app", "https://jedlik-vite-ts-template.netlify.app", "http://localhost:8080", "http://127.0.0.1:8080"],
                credentials: true,
            }),
        );
